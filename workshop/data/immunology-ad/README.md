...
# Data pack — Immunology — moderate-to-severe atopic dermatitis

Everything here is invented. Fictional company (Nordvant Biopharma), fictional
product (DERMALYX), fictional experts, fictional institutions. It is
...
| `field-observations.csv` | 54 field interaction records from one quarter |
