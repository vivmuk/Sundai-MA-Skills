...
# Payer and HTA evidence brief — ADIPOSYN
...
**Clinical evidence:** NVB-440, randomised, double-blind, placebo-controlled phase 3, n=2280; Mean weight change at week 72: −22.4% vs −2.6% placebo (difference −19.8 pp, 95% CI −21.1 to −18.5).  
...
**Draft claim to challenge:** "ADIPOSYN is cost-effective and reduces hospital use." Neither statement follows without thresholds, uncertainty and comparative data.
